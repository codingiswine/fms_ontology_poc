...
RDF_PATH = Path(os.getenv("FMS_VIS_CLEAN_RDF", BASE_DIR / "owl_vol1_clean.ttl"))
OUTPUT_HTML = Path(os.getenv("FMS_VIS_CLEAN_OUTPUT", BASE_DIR / "rdf_graph_search_with_clean.html"))
g = Graph()
